...
<div className="text-center mt-12">
    ...
    <ul className="flex flex-col font-semibold gap-4 mt-12 ">
        <li className={`flex gap-2 py-2  rounded-full   ${activete === "home" && "bg-yellow-500"}`
            ...
            <Link to="home" className="text-sm sm:text-md md:text-md lg:text-md xl:text-md"> home</Link></li>
        ...
        <li className={`flex gap-2  py-2 rounded-full ${activete === "users" && "bg-yellow-500"}`
            ...
            <Link to="users" className="text-sm sm:text-md md:text-md lg:text-md xl:text-md"> users</Link>
             </li>
        ...
        <li className={`flex gap-2  py-2 rounded-full ${activete === "addUser" && "bg-yellow-500"}`
            ...
            <Link to="addUser" className="text-sm sm:text-md md:text-md lg:text-md xl:text-md"> addUser</Link></li>
        ...
        <li className={`flex gap py-2 rounded-full ${activete === "profile" && "bg-yellow-500"}`
            ...
            <Link to="profile" className="text-sm sm:text-md md:text-md lg:text-md xl:text-md"> profile</Link> </li>

            <li className="flex gap-2 py-2 rounded-full"> <h2 className="font-semibold">
       <Link to=''><Close/></Link></h2>
    <FaOutdent size={22}/></li>
