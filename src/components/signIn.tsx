...
const Sign = ()=>{
   ...
   const{saveDate}=useContext(Context)
...
<div className="flex flex-col mt-10">
    ...
    <input type="text" placeholder="Enter your password"   className="border p-2 px-4 mt-1  rounded-md placeholder-gray-300 shadow-xl outline-none"
