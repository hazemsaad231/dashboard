...
export default function Emails() {
  ...
  const goToContactWithIds = () => {
    if (checkedIds.length === 0) {
      toast.error("لم يتم تحديد أي مشترك");
      return;
    }
            ...
            <div className="flex flex-col md:flex-row items-start md:items-center md:justify-between gap-4 mb-6 pb-4 border-b border-slate-200">
              ...
              <div className="flex gap-2">
                ...
                <button
                  ...
                  className="px-4 py-2 rounded-full bg-[#DFC96D] hover:bg-[#978644] text-white font-semibold transition-colors"
                >
                  {checkedIds.length === 0 ? "ارسال" : `ارسال (${checkedIds.length})`}
                </button>
              </div>
            </div>
